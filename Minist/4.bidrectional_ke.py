...
# NxDxD HxH -> NxDx2H return_sequences=True.若return_sequences=False 只返回正序与逆序的输出-> Nx2H
rnn1 = Bidirectional(LSTM(H, return_sequences=True))
x1 = rnn1(inputs=input_)
# Nx2H	# 默认channel last, input: (batch_size, steps, features) -> output: (batch_size, features)
