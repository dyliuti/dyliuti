from Data.DataExtract import load_translation, load_glove6B, load_text_patricipialed, load_translation_patricipialed
...
file_path = "Data/NLP2/党章"
en_path = "中国共产党党章En.txt"
ch_path_fenci = "中国共产党党章Ch_FenCi.txt"
...
input_texts = load_text_patricipialed(file_path=file_path, file_name=en_path, sample_num=NUM_SAMPLES)
translation_inputs, translation_outputs = load_translation_patricipialed(file_path=file_path, file_name=ch_path_fenci, sample_num=NUM_SAMPLES)
...
print(input_sequences[68])
print([tokenizer_inputs.index_word[index] for index in input_sequences[68]])
# 获取输入句子中的最大序列长度
...
print([tokenizer_outputs.index_word[index] for index in translation_sequences_outputs[68]])
# 获得词与索引的映射
